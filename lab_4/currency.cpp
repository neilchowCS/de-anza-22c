// Changes from lab 2
// Added virtual getName and getCopy methods, and changed the print function
// The getName function is implemented by its derived classes. 
//    Used to make sure the currencies are the same type.
//    Changed the error handling from using typeid to getName.
//    Added error handling using getName to functions that
//    took a Currency pointer as an argument.
// The print function prints the currency's value and type.
//    Changed from return type void to a string for use in
//    SinglyLinkedList printList() function
// The getCopy function is implemented by its derived classes.
//    Used to create copies of the currency.
#ifndef CURRENCY_H
#define CURRENCY_H
#include <iostream>
#include <cmath>
...
// Prints the  currency's value and name
// Pre:
// Post:
// Returns:
//    a string of the currency's value and name
std::string Currency::print() {
    std::string builder = "";
    builder =  std::to_string(whole) + "." + std::to_string(fraction) + " " + this->getName();
    return builder;
}
